...
## Light mode screens (main page)

<img src="https://github.com/user-attachments/assets/520d5106-9784-433d-b6b7-a97c708af33f" width="600">

## All light mode screens

<img src="https://github.com/user-attachments/assets/482bca76-bd6d-4aec-bc98-fa7ad3594346" width="600">

## Dark mode screens (main page)

<img src="https://github.com/user-attachments/assets/6193df7f-6d96-4121-8d75-f280c1d1d9f4" width="600">

## All dark mode screens

<img src="https://github.com/user-attachments/assets/0b750d42-b5ae-4b51-950c-9627ebdcb65d" width="600">

Several improvements have been implemented in the navigation component of the application, addressing issues encountered during transitions between screens, such as booking an appointment. These issues previously prevented proper navigation to subsequent pages. All screens are now fully functional, with no bugs detected during screen transitions.

The application has been tentatively named “BookPoint,” although this name may be subject to change in future iterations.

In the upcoming iteration, I will introduce a “mock” functional system to simulate the app’s intended functionality upon release. This will include utilizing mock databases for data such as profile pictures, business cover photos, names, and locations. Additionally, the development of business reviews is scheduled for the next iteration.
